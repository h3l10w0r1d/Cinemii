            ...
            {filteredFriends.map((friend) => (
              ...
              >
                <div className="relative">
                  ...
                  <span className="absolute -right-1 -bottom-1 w-4 h-4 rounded-full bg-green-500 ring-2 ring-bg" />
                </div>
          ...
          <div className="glass-dark rounded-3xl h-[75vh] flex flex-col border border-white/10 overflow-hidden">
            {!selected ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center px-6">
                ...
                <p className="text-muted text-sm mt-2">Choose someone from the left to start chatting.</p>
              </div>
            ) : (
              <>
                <div className="p-5 border-b border-white/10 flex items-center gap-3">
                  <div className="w-11 h-11 rounded-2xl overflow-hidden bg-white/10 flex items-center justify-center text-white font-black">
                    {selected.picture ? (
                      <img src={selected.picture} alt={selected.name} className="w-full h-full object-cover" />
                    ) : (
